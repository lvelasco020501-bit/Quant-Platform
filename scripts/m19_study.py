"""Run M19: a local reset under a global loss budget — policies H, I and J.

Research only. Reads M16's canonical 4h CSVs and writes evidence under ``var/research/m19/``.
...
Usage::
    ...
    uv run python scripts/m19_study.py [--workers 3] [--only XRPUSDT] [--policies H,J]
"""
...
from quantplatform.research.m19 import POLICIES_M19, local_overshoot
...
def job(asset_index: int, policy_index: int) -> dict[str, Any]:
    ...
    policy = POLICIES_M19[policy_index]
